...
const Tabs = ({ setTradeModalVisibility, isTradeModalVisible }) => {
    ...
    //we want to change state when the trade button is clicked
    ...
    return (
        <Tab.Navigator
            tabBarOptions={{
                showLabel: false, // just disabling the tab options names that are rendered from the tab.screen below.
                style: {
                    height: 140,
